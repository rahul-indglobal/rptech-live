...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  MINOVATE.navbar = {
    ...
    menu: function(){
      if( $dropdowns.length > 0 ) {
        ...
        var $childMenus = $dropdowns.find('ul');
        $childMenus.addClass('innermenu');
        $submenus.addClass('submenu');

        $dropdowns.append('<i class="fa fa-plus"></i>');
        $i = $dropdowns.children('i');
        ...
        $dropdowns.on('mouseleave', function() {
         console.log($(this))
         if($(this).parent('ul').hasClass('innermenu')){
           return
         }
  ...
  //$window.on( 'resize', MINOVATE.documentOnResize.init );
      ...
      //$(".closeWrap .fa.fa-times").click(function(){

     //     $(this).parents(".panel-collapse.collapse.in").fadeOut();
     //   });
       $(".closeWrap .fa.fa-times").click( function () {
           $("#sidebarNav.panel-collapse.in").fadeOut(300);
         });
       $(".btn-menu.collapsed").click( function () {
           $("#sidebarNav.panel-collapse.in").show(300);
         });
});
