...
{
    /** Url path */
    const AWARDS_URL_PATH_EDIT = 'award/admin/edit';
    const AWARDS_URL_PATH_DELETE = 'award/admin/delete';
    ...
    public function __construct(
        ...
        array $components = [],
        array $data = [],
        $editUrl = self::AWARDS_URL_PATH_EDIT
    ) {
