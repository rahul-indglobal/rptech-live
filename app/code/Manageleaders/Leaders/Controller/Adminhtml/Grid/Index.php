...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Manageleaders_Leaders::grid_list');
        $resultPage->getConfig()->getTitle()->prepend(__('Leadership Management'));
        return $resultPage;
    }
    ...
    {
        return $this->_authorization->isAllowed('Manageleaders_Leaders::grid_list');
    }
}
