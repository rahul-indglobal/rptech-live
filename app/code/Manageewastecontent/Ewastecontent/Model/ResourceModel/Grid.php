...
/**
 * Manageewastecontent_Ewastecontent Grid ResourceModel.
 * @category  Manageewastecontent_Ewastecontent 
 * @package   Manageewastecontent_Ewastecontent
 * @author    Lalita Rajput
 */

namespace Manageewastecontent\Ewastecontent\Model\ResourceModel;
...
class Grid extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb {
    ...
    protected function _construct() {
        $this->_init('rptech_ManageEwasteContent', 'entity_id');
    }
