define(
    ...
    function (Component, quote, $, ko, additionalValidators, setPaymentInformationAction, url, customer, placeOrderAction, fullScreenLoader, messageList, shippingSaveProcessor,storage) {
        'use strict';
            ...
            checkRzpOrder: function (data) {
                ...
                $.ajax({
                    ...
                    error: function (response) {
                        fullScreenLoader.stopLoader();
                        // self.isPaymentProcessing.reject(response.message);
                        self.isPaymentProcessing.reject('Please check any of product qty is not available');
                    }
                });
            },
                ...
                var options = {
                    ...
                    modal: {
                        ondismiss: function() {
                            ...
                            storage.post(
                                // custom brainvire missingorder module.
                                'missingorder/payment/revertqty',
                                true
                            ).done(
                                function (response) {
                                }
