...
class Location extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('delhivery_lastmile_location', 'location_id');
    }

    /**
     * Retrieves Manage Location Name from DB by passed id.
     *
     * @param string $id
     * @return string|bool
     */
     ...
     *
     * @param \Magento\Framework\Model\AbstractModel|\Delhivery\Lastmile\Model\Location $object
     * @return $this
     */
