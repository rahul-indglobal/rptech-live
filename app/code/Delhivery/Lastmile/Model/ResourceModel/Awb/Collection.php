 ...
 */
namespace Delhivery\Lastmile\Model\ResourceModel\Awb;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'delhivery_lastmile_awb_collection';
    ...
    {
        $this->_init(
            \Delhivery\Lastmile\Model\Awb::class,
            \Delhivery\Lastmile\Model\ResourceModel\Awb::class
        );
    }
