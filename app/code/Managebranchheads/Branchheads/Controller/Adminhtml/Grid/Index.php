...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Managebranchheads_Branchheads::grid_list');
        $resultPage->getConfig()->getTitle()->prepend(__('Branch  Head Management'));
        return $resultPage;
    }
    ...
    {
        return $this->_authorization->isAllowed('Managebranchheads_Branchheads::grid_list');
    }
}
