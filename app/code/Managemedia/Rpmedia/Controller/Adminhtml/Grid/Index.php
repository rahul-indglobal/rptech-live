...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Managemedia_Rpmedia::grid_list');
        $resultPage->getConfig()->getTitle()->prepend(__('Media Management'));
        return $resultPage;
    }
    ...
    {
        return $this->_authorization->isAllowed('Managemedia_Rpmedia::grid_list');
    }
}
