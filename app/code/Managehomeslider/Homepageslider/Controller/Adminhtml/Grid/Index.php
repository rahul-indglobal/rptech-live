...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Managehomeslider_Homepageslider::grid_list');
        $resultPage->getConfig()->getTitle()->prepend(__('Home Page Slider Management'));
        return $resultPage;
    }
    ...
    {
        return $this->_authorization->isAllowed('Managehomeslider_Homepageslider::grid_list');
    }
}
